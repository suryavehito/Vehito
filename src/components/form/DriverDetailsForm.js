...
import ViewDocumentsModal from "../modal/ViewDocumentsModal";
...
class DriverDetailsForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      openSnackbar: false,
      viewAllFields: false,
      viewDocumentsModalIsOpen: false,
    };
  }
  ...
  viewDocuments = () => {
    this.setState({ viewDocumentsModalIsOpen: true });
  };
      ...
      <Fragment>
        <div className="container">
          <form action="">
            ...
            {(this.state.viewAllFields || this.props.isEditable) && (
              <Fragment>
                <div className="row">
                  <div className="col-40">
                ...
                <div className="row">
                  ...
                  <div className="col-60">
                    <input
                      ...
                      value={
                        this.props.state &&
                        this.props.state.birthDate !== undefined &&
                        new Date(parseInt(this.props.state.birthDate))
                          .toISOString()
                          .substring(0, 10)
                      }
                    />
            ...
            >
              {!this.props.isEditable && (
                <Grid item xs={4}>
                  <Link component={Button} onClick={this.viewDocuments}>
                    {"View documents"}
                  </Link>
                </Grid>
              )}
              ...
              {!this.props.isEditable && (
                <Grid item xs={4}>
                  <Link to="/#vehicle/myassets">{"Do it later"}</Link>
                </Grid>
              )}
            </Grid>
        ...
        <ViewDocumentsModal
          open={this.state.viewDocumentsModalIsOpen}
          handleClose={() => this.setState({ viewDocumentsModalIsOpen: false })}
