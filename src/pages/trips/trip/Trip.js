...
export default function Trip(props) {
    ...
    const saveBtnOnClickHandler = () => {
        const addAssetResponse = props.new ? addTrip(tripData) : updateTrip(tripData);
    ...
    const removeBreakPoint = (index) => () => {
        const tmpBreakPoints = [...tripData.breakPoints.slice(0, index), ...tripData.breakPoints.slice(index + 1, tripData.breakPoints.length)];
