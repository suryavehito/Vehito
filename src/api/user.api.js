...
import { USER_GET_PROFILE, USER_LOGIN, USER_SIGN_UP, USER_UPDATE_PREFERENCES, USER_UPDATE_PROFILE } from "./constant";
...
export const updatePreferences = async (data) => {
    ...
    const result = await api.post(USER_UPDATE_PREFERENCES, { ...data, ownerId }, {
